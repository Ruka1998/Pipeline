...
namespace JTRP.ShaderDrawer
{
    ...
    public class SubDrawer : MaterialPropertyDrawer
    {
        ...
        public override float GetPropertyHeight(MaterialProperty prop, string label, MaterialEditor editor)
        {
            ...
            // return needShow ? height : -EditorGUIUtility.standardVerticalSpacing;
        }
        // 绘制自定义样式属性
    ...
    public class TexDrawer : SubDrawer
    {
        ...
        public override void DrawProp(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
        {
            ...
            var noScaleOffset = (prop.flags & MaterialProperty.PropFlags.NoScaleOffset) != MaterialProperty.PropFlags.None;
            if (p != null)
            {
                Rect rect = Rect.zero;
